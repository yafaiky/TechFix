...
import { ArrowBigLeftDash } from "lucide-react"; // pastikan pakai lucide-react
                ...
                <div className="bg-white shadow-md rounded-xl p-5">
                    ...
                    <div className="space-y-1 text-sm text-gray-700">
                        ...
                        <p>
                            ...
                            <span
                                className={`px-2 py-1 rounded-md text-xs font-semibold ${service.serviceStatus === "DONE"
                        ...
                        <p><span className="font-medium text-gray-500">Dibuat:</span> {new Date(service.createdAt).toLocaleString()}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white shadow-md rounded-xl p-5">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {service.media.map((m) => (
                            ...
                            >
                                <p><span className="font-medium text-gray-500">Tanda Tangan :</span> {m.signature}</p>
                                <p><span className="font-medium text-gray-500">Dokumentasi :</span> {m.dokumentasi || "-"}</p>
                                <p><span className="font-medium text-gray-500">Hasil Jadi :</span> {m.hasil || "-"}</p>
                            </div>
                        ))}
                    </div>
                </div>
